    ...
    return (
        <Sheet>
            ...
            <SheetContent className='flex w-full flex-col pre-0 sm:max-w-lg'>
                <SheetHeader className='space-y-2.5 pre-6'>
                    ...
                    itemCount > 0 ? (
                        ...
                        <div className="flex h-full flex-col items-center justify-center space-y-1">
                            <div className="relative mb-4 h-60 w-60 text-muted-foreground" aria-hidden='true'>
                                <Image src='/hippo-empty-cart.png' fill alt='hippo-empty-cart.png'/>
                            </div>
                            ...
                            <SheetTrigger asChild>
                                <Link href='/products' className={buttonVariants({
                                    variant:'link',
                                    size:'sm',
                                    className:'text-sm ttext-muted-goteground'
                                })}>
